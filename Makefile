...
docs:
	...
	inspect googleanalytics.auth $(docopts) >> docs/build/interface.md
	inspect googleanalytics.account $(docopts) >> docs/build/interface.md
	inspect googleanalytics.query $(docopts) >> docs/build/interface.md
